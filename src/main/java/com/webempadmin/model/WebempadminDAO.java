...
//	@Override
	...
	public static void readPicture(Blob blob) throws IOException, SQLException {  //傳入拿到的blob物件
		InputStream is = blob.getBinaryStream();
		FileOutputStream fos = new FileOutputStream("Output/1.png"); //把拿到的資料輸出 存入output資料夾
		int i; 
		while ((i = is.read()) != -1) {
			fos.write(i);
			fos.flush();
	...
	public static void readPicture(InputStream is) throws IOException {
		FileOutputStream fos = new FileOutputStream("C:/Users/jumbo/Desktop/專題相關/1.png");
		int i;
		while ((i = is.read()) != -1) {
			fos.write(i);
			fos.flush();
