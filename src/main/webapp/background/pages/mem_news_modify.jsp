	...
	<ul>
		<c:forEach var="message" items="${errorMsgs}">
			<li style="color:red">${message}</li>
              ...
              <FORM METHOD="post"  ACTION="usernews.do" name="form1" enctype="multipart/form-data">
...
<%-- 										<input type="text" class="form-control" name="userName" value="${userinfo.userName}"> --%>
							...
							<!-- /.card-body -->
							<div class="card-footer" style="text-align: center; padding-top: 5px; display : inline">
							<div style="text-align: center; padding-top: 5px; display : inline">
